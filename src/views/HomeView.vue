...
<div class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-cover bg-background">
	...
	<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-90 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<h1 class="text-3xl font-bold pt-8 lg:pt-0">Phone Myint Mar</h1>
			...
			<p class="pt-8 text-base">Hello, My name is Phone Myint Mar.
                <br>
                This site is for my knowledge sharing and blogging personal experiences. Enjoy the content!!
            </p>
