<template>
  <div class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-cover bg-background">
    <div
      class="max-w-5xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0"
    >
      <!--Main Col-->
      <div
        id="profile"
      ...
      >
        <div class="p-4 md:p-12 text-center lg:text-left">
          ...
          <h1 class="text-3xl font-bold pt-8 lg:pt-0 text-black">
            Phone Myint Mar
          </h1>
          <div
          ...
          >
            <svg
              class="h-4 fill-current text-blue-600 pr-4"
          ...
          <p class="pt-8 text-base">
            Hello, My name is Phone Myint Mar.
            <br />
            This site is for my knowledge bloggin and sharing personal
            experiences. Enjoy the content!!
          </p>
          ...
          >
            <!-- <a class="link" href="#" data-tippy-content="@facebook_handle"
              ><svg
                class="h-6 fill-current text-gray-600 hover:text-blue-600"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <a
              class="link"
              href="https://github.com/phonemyintmar"
            ...
            ></a>
            <a class="link" href="https://www.instagram.com/phonemyintmar/" data-tippy-content="@instagram_handle"
              ><svg
                class="h-6 fill-current text-gray-600 hover:text-blue-600"
                role="img"
                viewBox="0 0 24 24"
              ...
              >
                ...
                /></svg
            ></a>
            <a class="link" href="https://www.linkedin.com/in/phone-myint-mar-64b4391aa/" data-tippy-content="@linkedin_handle"
              ><svg
              class="h-6 fill-current text-gray-600 hover:text-blue-600"
                role="img"
                viewBox="0 0 24 24"
